...
class Maml1st_Order(AlgorithmsABC):
    """
        Core Implementation of the Maml_1st Order algorithm
        """

    def __init__(self, **kwargs):
        super(Maml1st_Order, self).__init__(**kwargs)

        self.alg_name = "Maml1st_Ord_"
    ...
    def train_and_evaluate(self):
        ...
        for episode in range(0, self.episodes):
            ...
            # go back on theta parameters for the update from the previous episodes
            ...
            if episode % self.eval_interval == 0:
                ...
                for dataset in (self.train_dataset, self.test_dataset):
                    ...
                    for lab_index, predict_lab in enumerate(eval_predicts.argmax(1)):
