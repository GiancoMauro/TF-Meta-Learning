...
for experim_num in range(experiments_num):
    ...
    new_directory = Algorithm_name + str(meta_iters) + "_shots_" + str(support_train_shots) + "_simul_num_" + str(
        experim_num)
    ...
    train_eval_boxes, test_eval_boxes = generate_box_plot(plot_config, Algorithm_name, classes, meta_iters,
